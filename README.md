...
> JeayBit은 암호화폐 트레이딩을 연습할 수 있는 환경을 제공하는 서비스입니다. <br>
> 암호화폐 거래에 입문하려는 사용자들은 높은 변동성에 부담을 느낍니다. JeayBit은 이러한 문제를 해결하고 금전적인 부담 없이 암호화폐 거래 경험을 쌓을 수 있도록 돕고자 합니다. <br>
...
### 리팩토링
> 2024.05 - 2024.07(웹소켓 추가 및 컴포넌트 세분화) <br>
> 2024.12 - 2024.12(API 최적화 및 반응형 디자인 구현)
