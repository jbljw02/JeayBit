...
- 배포 URL: https://jeaybit.site (서버가 닫혀있을 시, 첫 접속에 대해 최대 1분 정도의 대기시간 소요)
...
### 3) 화폐 리스트, 호가/체결내역, 차트
- 화폐의 정보는 주기적으로 갱신됩니다.
- 우측 : 화폐 리스트에서 화폐 정렬/검색 및 관심 화폐 추가가 가능하며, 선택한 화폐에 따라 다른 컴포넌트가 상호작용합니다.
...
- (3) - 미체결 거래는 주문을 취소할 수 있습니다. 체결된 거래들은 '거래내역'란에서 확인할 수 있습니다.
