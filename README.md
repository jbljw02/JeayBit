...
> 기존의 응답시간이 길고 복잡한 암호화폐 거래소들과는 달리, 필수적인 기능들만을 채택하여 개발한 트레이딩 뷰입니다. 화폐 거래는 실제 거래가 아닌 임의의 가상 환경에서 진행됩니다. <br>
- 배포 URL : https://bejewelled-lebkuchen-60ed40.netlify.app/
...
### 5) 매수 및 매도, 주문취소
- 매수 및 매도를 할 때 호가(시장에 나와있는 값)와 일치하는 가격으로 요청하면 즉시 거래가 체결됩니다.
