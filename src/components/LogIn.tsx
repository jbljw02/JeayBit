      ...
      <div className="div-logIn">
        ...
        <div className="view-logIn">
          ...
          <div className="section-email">
            ...
            <div onClick={() => inputClick('email')} className={`logIn-email ${activeInput === 'email' ? 'container-input-click' : 'container-input-nonClick'}`}>
              ...
              <input type="text" className="input-signUp" placeholder="이메일"></input>
            </div>
          </div>
          ...
          <div className="section-password">
            ...
            <div onClick={() => inputClick('password')} className={`logIn-password ${activeInput === 'password' ? 'container-input-click' : 'container-input-nonClick'}`}>
              <input type={visiblePassword ? "text" : "password"} className="input-signUp" placeholder="비밀번호"></input>
              {
                visiblePassword ?
          ...
          <span className="logIn-submit">로그인</span>
