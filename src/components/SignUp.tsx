      ...
      <div className="div-signUp">
        ...
        <div className="view-signUp">
          ...
          <div className="section-email">
            ...
            <div onClick={() => inputClick('email')} className={`signUp-name ${activeInput === 'email' ? 'container-input-click' : 'container-input-nonClick'}`}>
          ...
          <div className="section-password">
            ...
            <div onClick={() => inputClick('password')} className={`signUp-name ${activeInput === 'password' ? 'container-input-click' : 'container-input-nonClick'}`}>
              <input type={visiblePassword ? "text" : "password"} className="input-signUp"></input>
              {
                visiblePassword ?
